...
import com.sujoy.calculators.base.prefs.FontSize;
...
public class PreferencesBar extends HorizontalLayout {
    ...
    private final RadioButtonGroup<Currency> currencyGroup = new RadioButtonGroup<>();
    ...
    private void configureCurrencyGroup() {
        this.currencyGroup.setItems(Currency.values());
        ...
        this.currencyGroup.addValueChangeListener(e -> {
            if (e.getValue() != null) this.prefs.setCurrency(e.getValue());
        });
    }
    ...
    private void configureFontSizeGroup() {
        ...
        this.fontSizeGroup.addValueChangeListener(e -> {
            if (e.getValue() != null) this.prefs.setFontSize(e.getValue());
        });
    }
